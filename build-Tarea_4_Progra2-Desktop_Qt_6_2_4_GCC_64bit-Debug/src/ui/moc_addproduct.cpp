...
#include <memory>
#include "../../../Tarea_4_Progra2/src/ui/addproduct.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_addProduct_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_addProduct_t qt_meta_stringdata_addProduct = {
    {
QT_MOC_LITERAL(0, 10) // "addProduct"
...
const QMetaObject addProduct::staticMetaObject = { {
    ...
    qt_meta_stringdata_addProduct.offsetsAndSize,
    qt_meta_data_addProduct,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_addProduct_t
